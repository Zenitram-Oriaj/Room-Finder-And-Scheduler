	...
	return {
		...
		link:     function ($scope, $elem) {
			...
			$scope.$watch("data", function (newVal, oldVal) {
				...
				if ($scope.legend){
					var aa = angular.element($elem[0]).parent().parent().prepend("<div class=\"col-md-3\"></div>");
					var bb = angular.element(aa).children();
					angular.element(bb[0]).append(chartCreated.generateLegend());
