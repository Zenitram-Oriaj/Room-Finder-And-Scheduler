...
app.service('weather', function ($http) {
    ...
    // https://api.forecast.io/forecast/28d8e8e2b24bf6d955bf34a0bd4fd87c/36.1215,-115.1739?units=us&callback=?
		// console.info('Forecast Request For ' + lat + ',' + log);
		//return $http.get('https://api.forecast.io/forecast/28d8e8e2b24bf6d955bf34a0bd4fd87c/'+ lat + ',' + log + '?units=us&callback=?');
